---
description: >
  Roda o pipeline completo de due diligence transnacional para uma pessoa
  física brasileira. Busca em FEC, LDA, FARA, registros corporativos estaduais
  (FL, DE, TX), OpenCorporates e imprensa BR/EUA. Produz dossiê PDF com fontes
...
Se não: informar ao usuário que o pipeline é restrito a investigações de interesse público.
